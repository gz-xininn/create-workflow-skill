...
执行 Step 3-10 时，先定位模板目录，然后按需 Read 对应模板文件：
    ...
    Glob('**/create-workflow-skill/templates/*.md')
...
| 步骤 | 模板文件 | 生成目标 | 说明 |
|------|---------|---------|------|
| Step 3 | templates/claude-md.md | CLAUDE.md | 主入口配置 |
| Step 4 | templates/roles-md.md | ROLES.md | 角色注册表与权限矩阵 |
| Step 5 | templates/role-contexts.md | docs/rules/roles/*.md | 各角色上下文文件 |
| Step 6 | templates/guardrails.md | .claude/rules/guardrails/*.md | 护栏规则文件 |
| Step 7 | templates/workflows.md | docs/rules/workflows/*.md | 工作流程文件 |
| Step 8a | templates/skills-core.md | .claude/skills/{task-init,context-handoff,knowledge-sync}/SKILL.md | 核心技能 |
| Step 8b | templates/skills-quality.md | .claude/skills/{acceptance-check,security-gate,generate-help}/SKILL.md | 质量技能 |
| Step 9 | templates/knowledge-base.md | knowledge-base/ | 知识库结构 |
| Step 10 | templates/settings.md | .claude/settings.json | 权限配置 |
